...
function get_bold_in_number(bold_in_bool)
	if bold_in_bool then
		return 1
	else
		return 0
	end
...
function display_list()
	...
	mp.add_forced_key_binding("x", "recent-DEL", function()
	...
	mp.add_forced_key_binding("q", "recent-ESC", function()
		unbind()
	end)
end
