return require('packer').startup(function(use)
  ...
  use({
    ...
    opt = true,
    wants = {
      "vim-vsnip-integ", "flutter-snippets", "awesome-flutter-snippets",
      "bloc_snippets", "friendly-snippets"
    },
    requires = {
  ...
  use({
    ...
    cmd = {"Telescope"},
    keys = {
      "<leader>fp", "<leader>ff", "<leader>fg", "<leader>fb", "<leader>fh",
      "<leader>fr"
    },
    wants = {
      "trouble.nvim", "plenary.nvim", "project.nvim",
  ...
  use({
    ...
    event = "BufRead",
    wants = {
      "playground", "nvim-treesitter-textobjects", "nvim-treesitter-refactor",
      "nvim-ts-context-commentstring", "nvim-ts-rainbow"
    },
    requires = {
  ...
  use({
    ...
    event = "bufRead",
    config = function() require("config.scrollview") end
  })
  ...
  use({
    "folke/trouble.nvim",
    keys = {
      "<leader>xx", "<leader>xw", "<leader>xd", "<leader>xl", "<leader>xq",
      "gR", "gD"
    },
    event = "BufReadPre",
    requires = "kyazdani42/nvim-web-devicons",
  ...
  use({
    ...
    wants = "lua-dev.nvim",
    requires = {
      "kabouzeid/nvim-lspinstall", "onsails/lspkind-nvim",
  ...
  use({
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap("n", "<leader>vm", ":MundoToggle<cr>",
  ...
  use({
    ...
    config = function()
      vim.api.nvim_set_keymap("n", "<leader>m", ":MaximizerToggle!<cr>",
                              {noremap = true, silent = true})
      vim.api.nvim_set_keymap("v", "<leader>m", ":MaximizerToggle!<cr>gv",
                              {noremap = true, silent = true})
    end
  })
