return require( 'packer' ).startup( function( use )
  ...
  use( {
    "hrsh7th/vim-vsnip",
    opt = true,
    wants = { "vim-vsnip-integ", "flutter-snippets", "awesome-flutter-snippets", "bloc_snippets", "friendly-snippets" },
    requires = {
  ...
  use( {
    ...
    requires = {
      ...
      { "romgrk/nvim-treesitter-context", config = function() vim.cmd( "hi TreesitterContext guibg=#292e42" ) end },
